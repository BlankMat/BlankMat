...
{
public:
    PPlane(float size, bool doubleSided, Shader* shader, Material* material, Material* defaultMat, State* state, bool drawOver,
        glm::vec3 pos = glm::vec3(0.0f), glm::vec3 rot = glm::vec3(0.0f), glm::vec3 scale = glm::vec3(1.0f))
        : IPrimitive(shader, material, defaultMat, state, 0.0f, drawOver, pos, rot, scale)
    {
